...
> = {
  ...
  brand_understanding: ["creative_generation", "strategy"],
  competitor_understanding: ["strategy"],
  strategy: ["channel_planning", "creative_generation", "campaign_suggestions"],
  channel_planning: ["creative_generation"],
  creative_generation: ["campaign_suggestions"],
