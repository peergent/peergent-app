...
export function buildMarketingPeerDomainInput(input: {
  ...
  return {
    ...
    creativeBriefByCampaignId: workspace.creativeBriefByCampaignId,
    linkedinPostByWorkUnitId: workspace.linkedinPostByWorkUnitId,
    emailByWorkUnitId: workspace.emailByWorkUnitId,
    plan: workspace.plan,
